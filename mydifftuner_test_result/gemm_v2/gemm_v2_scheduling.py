...
if __name__ == '__main__':
    ...
    task = autotvm.task.create(Gemm_tv2_reorder2_3_vec1_para1_unrollv1_packv1_writecachev1_config_define, args=(N, K, M, dtype), target=target)
    measure_option = autotvm.measure_option(builder='local', runner=autotvm.LocalRunner(number=5))
    myTuner = useTuner("xgb",1000,task,measure_option)
