...
if __name__ == '__main__':
    ...
    s = tvm.create_schedule(C.op)
    dict_autoschedule = {'parallel':Gemm_tv2_reorder2_3_vec1_para1_config_define,'unroll':Gemm_tv2_reorder2_3_vec1_para1_unrollv1_config_define,'packing':Gemm_tv2_reorder2_3_vec1_para1_unrollv1_packv1,'write cache':Gemm_tv2_reorder2_3_vec1_para1_unrollv1_packv1_writecachev1}
    ...
    Tuner = useTuner("xgb",16,task,measure_option)
...
##这里定义的schedule是具体的,没有暴露出可调节的参数,感觉这里任然是手工调节，并且在面对不同的问题上有较大的不确定性
    ...
    print(Tuner.cost_model)
    print(Tuner.task)
    print(Tuner.flops_max)
    print(Tuner.param)
    print(Tuner.best_measure_pair)
    print(Tuner.dims)
    print(Tuner.ys)
