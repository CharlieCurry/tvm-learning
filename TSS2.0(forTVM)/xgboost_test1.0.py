...
@count_time
def situation0(X,Y,xgb_params, plan_size, log_interval):
...
@count_time
def situation1(X,Y,xgb_params, plan_size, log_interval):
    ...
    fit_and_evaluation(x_train, y_train, x_valiation, y_valiation, xgb_params, plan_size, log_interval)
@count_time
def situation2(X, Y, xgb_params, plan_size, log_interval):
    ...
    fit_and_evaluation(x_train, y_train, x_valiation, y_valiation, xgb_params, plan_size, log_interval)
@count_time
def situation3(X, Y, xgb_params, plan_size, log_interval):
    ...
    fit_and_evaluation(x_train, y_train, x_valiation, y_valiation, xgb_params, plan_size, log_interval)
@count_time
def situation4(X, Y, xgb_params, plan_size, log_interval):
    ...
    fit_and_evaluation(x_train, y_train, x_valiation, y_valiation, xgb_params, plan_size, log_interval)
@count_time
def situation5(X, Y, xgb_params, plan_size, log_interval):
    ...
    fit_and_evaluation(x_train, y_train, x_valiation, y_valiation, xgb_params, plan_size, log_interval)
@count_time
def situation6(X, Y, xgb_params, plan_size, log_interval):
